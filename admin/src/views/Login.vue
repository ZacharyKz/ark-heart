...
.input {
  width: 100%; height: 48px; border: 1px solid #EDEDEB; border-radius: 10px;
  padding: 0 16px; font-size: 15px; outline: none; margin-bottom: 16px;
  transition: border-color 0.2s;
}
.input:focus { border-color: #6B9E7D; }
.btn {
  width: 100%; height: 48px; background: #6B9E7D; color: #fff;
  border: none; border-radius: 10px; font-size: 16px; font-weight: 600;
  cursor: pointer; transition: background 0.2s;
}
.btn:hover { background: #5A8A6C; }
.btn:disabled { background: #ccc; cursor: not-allowed; }
.error { color: #991B1B; font-size: 13px; text-align: center; margin-top: 12px; }
</style>
